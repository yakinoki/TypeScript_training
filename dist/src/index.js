...
console.log((0, functions_1.Hello)('Paul')); // Output: Hello, Paul
console.log((0, TEST_1.testHello)('Paul')); // Output: Hello from test, Paul
console.log((0, TEST_1.testHello_2)('Paul')); // Output: Hello from test, Paul
let versions = {
    102: true,
    200: false,
};
...
console.log((0, functions_1.MSGtest)('ok!')); // Output: Message: ok!
// 非同期関数を呼び出し、結果を処理する
async function main() {
    try {
        console.log("データを取得中...");
        const result = await (0, functions_1.fetchData)(); // fetchData関数をawaitで呼び出し
